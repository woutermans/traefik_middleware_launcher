package traefik_middleware_launcher_test
...
func TestDemo(t *testing.T) {
	cfg := traefik_middleware_launcher.CreateConfig()
	...
	handler, err := traefik_middleware_launcher.New(ctx, next, cfg, "demo-plugin")
	if err != nil {
		t.Fatal(err)
	}
